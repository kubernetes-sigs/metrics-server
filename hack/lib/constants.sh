...
readonly OS_GO_PACKAGE=github.com/kubernetes-incubator/metrics-server
...
readonly OS_ALL_IMAGES=(
  origin-metrics-server
)

# os::build::images builds all images in this repo.
function os::build::images() {
  tag_prefix="${OS_IMAGE_PREFIX:-"openshift/origin"}"
  os::build::image "${tag_prefix}-metrics-server" images/metrics-server
}