...
| `apiService.create`                              | If `true`, create enabled metrics APIService resources. You typically want this enabled! If you disable API service creation you have to manage it outside of this chart for e.g horizontal pod autoscaling to work with this release.                       | `true`                                                                         |
| `apiService.v1.create`                           | If `true`, create the `v1.metrics.k8s.io` APIService.                                                                                                                                                                                                          | `true`                                                                         |
| `apiService.v1beta1.create`                      | If `true`, create the `v1beta1.metrics.k8s.io` APIService.                                                                                                                                                                                                     | `true`                                                                         |
