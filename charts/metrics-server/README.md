...
| `addonResizer.extraEnv`                          | Additional environment variables for the _nanny_ container, as a map of name to value.                                                                                                                                                                           | `{}`                                                                           |
...
| `extraEnv`                                       | Additional environment variables for the _metrics-server_ container, as a map of name to value.                                                                                                                                                                  | `{}`                                                                           |
