...
%global package_name origin-metrics-server
%global product_name Kubernetes Metrics API Server
%global import_path github.com/openshift/kubernetes-metrics-server

Name:           %{package_name}
Version:        %{version}
Release:        %{release}%{?dist}
Summary:        The Metrics API Server exposes cluster wide resource metrics as an API.
License:        ASL 2.0
